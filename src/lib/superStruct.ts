...
export type SuperStructArray<T extends Record<string, unknown>, Data, ArrayData = unknown> = {
	...
	[Property in AllKeys<T>]?: [T] extends [any]
		? NonNullable<PickType<T, Property>> extends Record<string, unknown>
			? ArrayData &
					SuperStructArray<MergeUnion<NonNullable<PickType<T, Property>>>, Data, ArrayData>
			: NonNullable<PickType<T, Property>> extends (infer A)[]
				? ArrayData &
						Record<
							number | string,
